...
const ContractForm = ({ initialDate }: ContractFormProps) => {
  ...
  return (
    <div className="space-y-6">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Select onValueChange={field.onChange}>
                          ...
                          <SelectContent>
                            <SelectItem value="15minutes">
                              15 minutes
                            </SelectItem>
                            <SelectItem value="30minutes">
                              30 minutes
                            </SelectItem>
                            <SelectItem value="45minutes">
                              45 minutes
                            </SelectItem>
                            <SelectItem value="1heure">1 Heure</SelectItem>
                            <SelectItem value="1heure15minutes">
                              1 heure 15 minutes
                            </SelectItem>
                            <SelectItem value="1heure30minutes">
                              1 Heure 30 minutes
                            </SelectItem>
                            <SelectItem value="1heure45minutes">
                              1 heure 45 minutes
                            </SelectItem>
                            <SelectItem value="2heures">2 Heures</SelectItem>
                          </SelectContent>
                        </Select>
                      </FormControl>
                      <FormMessage />
      ...
      {/* <div>
        <h1 className="font-semibold">Commentaire</h1>
        <Commantaires />
      </div> */}
    </div>
  );
